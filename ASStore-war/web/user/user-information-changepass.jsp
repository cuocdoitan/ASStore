      ...
      <div class="col-6 m-l-r-auto m-t-40">
        <form action="">  
          ...
          <div class="bo4 of-hidden size15 m-b-20">
            <input class="sizefull s-text7 p-l-22 p-r-22" type="password" name="old_pass" placeholder="Old password">
          </div>
          <hr>
          <label>New password</label>
          <div class="bo4 of-hidden size15 m-b-20">
            <input class="sizefull s-text7 p-l-22 p-r-22" type="password" name="new_pass" placeholder="New password">
          </div>
