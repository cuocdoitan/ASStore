...
<section class="bgwhite p-t-70 p-b-50">
    <div class="container">
        ...
        <form action="<c:url value="/products/edit"/>"  method="post" onsubmit="return validateProductInsert();" id="formEditProduct">    
    ...
    <hr>
    <button class="flex-c-m size1 bg4 bo-rad-23 hov1 s-text1 trans-0-4" onclick="submitEditProductForm()">
        Edit
    </button>
    <div>
