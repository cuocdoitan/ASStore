          ...
          <tbody>
            <c:forEach items="${animeList}" var="anime" >
              <tr>
                ...
                <td class="text-center p-t-10 p-b-10 p-l-20 p-r-20">
                    <a href="<c:url value='/admin/anime/update?anime=${anime.id}'/>" style="color: #3498db">Edit</a>
                  <%-- TODOS: IF NOT LAZY ANYMORE, USE SWEETALERT --%>
                  <a href="<c:url value="/admin/anime/delete?anime=${anime.id}" />" style="color: #e74c3c"  onclick="return confirm('Are you sure ?')">Delete</a>
                </td> 
              </tr>
            </c:forEach>
          </tbody> 
